...
class Transportation:
    ...
    def create_graph(self):
        ...
        outTextGraph += self.name + ":\n"
        #print(self.name + ":")
        outTextGraph += print_val(name = "Cost", value = cost, max=50)
        outTextGraph += print_val(name = "Time", value = time, max=50)
        outTextGraph += print_val(name = "Comfort", value = comfortability, max=50)
        outTextGraph += self.description + "\n"
